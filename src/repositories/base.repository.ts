...
export default class BaseRepository<T extends Document> {
    ...
    async updateById(id: string, update: Partial<T>, projection: string = "", options?: QueryOptions) {
        return await this.model.findByIdAndUpdate(id, update, { new: true, ...options }).select(projection);
    }
